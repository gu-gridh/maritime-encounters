...
class Period(abstract.AbstractBaseModel):
    ...
    phase = models.ForeignKey(Phase, on_delete=models.CASCADE, null=True, blank=True, related_name='period_phase', verbose_name=_("phase"), help_text=_("The phase of the period."))
...
class Element(abstract.AbstractBaseModel):
    name = models.CharField(max_length=256, null=True, blank=True, verbose_name=_("elemant_name"), help_text=_("The elemant name of the sample."))
    symbol = models.CharField(max_length=256, null=True, blank=True, verbose_name=_("element_symbol"), help_text=_("The element symbol of the sample."))
...
class Site(abstract.AbstractBaseModel):
    ...
    ADM1     = models.ForeignKey(geography.ADM1, null=True, blank=True,  related_name="sites", on_delete=models.SET_NULL, verbose_name=_("AMD1"), help_text=_("ADM1"))
    ADM2 = models.ForeignKey(geography.ADM2, null=True, blank=True,  related_name="sites", on_delete=models.SET_NULL, verbose_name=_("AMD2"), help_text=_("ADM2"))
    ADM3       = models.ForeignKey(geography.ADM3, null=True, blank=True,  related_name="sites", on_delete=models.SET_NULL, verbose_name=_("AMD3"), help_text=_("ADM3"))
    ADM4 = models.ForeignKey(geography.ADM4, null=True, blank=True,  related_name="sites", on_delete=models.SET_NULL, verbose_name=_("AMD4"), help_text=_("ADM4"))
...
class NewSamples(abstract.AbstractBaseModel):
    ...
    weight = models.CharField(max_length=128, null=True, blank=True, verbose_name=_("weight"), help_text=_("The weight of the metal."))
...
class MetalAnalysis(abstract.AbstractBaseModel):
    ...
    object_description = models.ForeignKey(ObjectDescription, on_delete=models.CASCADE, null=True, blank=True, verbose_name=_("object_description"), help_text=_("The object description of the metal."))

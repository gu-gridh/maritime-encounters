...
router.register(rf'{endpoint}/radiocarbon', views.RadioCarbonViewSet, basename='radiocarbon')
...
urlpatterns = [
    ...
    *utils.get_model_urls('resources', f'{endpoint}', exclude=['site', 'metal_analysis', 'metalwork', 'boat', 'lnhouses', 'radiocarbon']),
    *documentation
]